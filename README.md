...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-13 00:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cb791587-e0e1-443f-8fcc-6dfcc04a35e1.git
$ cd cb791587-e0e1-443f-8fcc-6dfcc04a35e1
```
